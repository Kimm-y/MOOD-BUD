...
const Home = () => {
    ...
    <div className="card" >
        <div className="card-body">
         <h5 className="card-title display-6 ml-5 text-center">WHY MENTAL HEALTH IS IMPORTANT</h5>
            ...
            <br/>
            According to global health organisations, one in four people worldwide will be affected by a mental or neurological disorder at some point in their lives.  <br />These conditions not only affect individuals but reverberate through families, communities, and economies. Here we can see how mental health is not only an individual issue, but how taking care of your mental health means you are taking care of the health of so many others. 
            </p>
    ...
    <div className="shadow-lg p-3 mb-5 bg-body-tertiary rounded mt-10"> 
      ...
      <ul>
        ...
        <li>
          <strong>Anxiety Disorders:</strong> This category includes various disorders like generalised anxiety disorder, panic disorder, and social anxiety disorder. Anxiety disorders involve excessive worry, fear, or nervousness that can interfere with daily functioning.
        </li>
        <li>
          <strong>Eating Disorders:</strong> Eating disorders involve extreme attitudes, behaviours, and emotions related to food and weight.
        </li>
        <li>
          <strong>Post-Traumatic Stress Disorder (PTSD):</strong> PTSD can develop after experiencing a traumatic event, or through chronic exposure to traumatising circumstances. Symptoms may include flashbacks, nightmares, and severe anxiety, impacting daily life.
        </li>
        <li>
          <strong>Burnout:</strong> While burnout shares some symptoms with depression, it is typically associated with work-related stress. Symptoms may include chronic fatigue, reduced performance, and feelings of cynicism.
        </li>
        <li>
          <strong>Personality Disorders:</strong> A group of mental health conditions characterised by enduring patterns of cognition, emotion, and behaviour that deviate significantly from cultural expectations. These patterns often lead to impaired functioning in various aspects of life, including relationships, work, and self-identity.
        </li>
        <li>
          <strong>Substance Use Disorder:</strong> Substance use disorder involves problematic use of substances, leading to significant impairment or distress. It includes disorders related to alcohol, drugs, and other addictive substances.
        </li>
      </ul>
